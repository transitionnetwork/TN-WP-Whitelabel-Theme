	...
	if( have_rows('flexible_content') ):
		...
		while ( have_rows('flexible_content') ) : the_row();
			...
			<?php elseif( get_row_layout() === 'faqs' ): ?>
				<?php $accordion_open = get_sub_field('initialise_open'); ?>
						...
						<?php while ( have_rows('faq_item') ) : the_row(); ?>
							<div class="card">
								<div class="card-header" role="tab" id="headingOne">
									<h5 class="mb-0">
										<a <?php echo ($i > 1 && !$accordion_open) ? 'class="collapsed"' : ''; ?> data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i; ?>" aria-expanded="<?php echo($i === 1) ? 'true' : 'false'; ?>" aria-controls="collapse<?php echo $i; ?>">
